...
public class EmployeeUnitTest1
{
    ...
    public void CreateEmployee_MissingDocumentValue_DomainExceptionShortName()
    {
    ...
    public void CreateEmployee_WithNullDocumentValue_DomainExceptionShortName()
    {
    ...
    public void CreateEmployee_MissingNameValue_DomainExceptionShortName()
    {
    ...
    public void CreateEmployee_WithNullNameValue_DomainExceptionShortName()
    {
