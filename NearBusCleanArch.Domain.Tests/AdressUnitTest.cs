...
public class AdressUnitTest
{
    ...
    {
        Action action = () => new Adress(1, "", "fake neighborhood", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
    ...
    {
        Action action = () => new Adress(1, null, "fake neighborhood", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid street. Street is required");
    }
    ...
    {
        Action action = () => new Adress(1, "test", "fake neighborhood", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", null, "fake cityyy", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid neighborhood. Neighborhood is required");
    }
    ...
    {
        Action action = () => new Adress(1, "fake street", "test", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", null, "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid city. City is required");
    }
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "t", "fake state", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake cityyy", "", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake cityyy", null, "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid state. State is required");
    }
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake city", "f", "232", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake cityyy", "fake state", "", "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake cityyy", "fake state", null, "83608070");
        action.Should()
            .Throw<NearBusCleanArch.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid number. Number is required");
    }
    ...
    {
        Action action = () => new Adress(1, "fake street", "fake neighborhood", "fake cityyy", "fake state", "232", "83608070");
        action.Should()
